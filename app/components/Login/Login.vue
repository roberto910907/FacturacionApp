    ...
    <Page actionBarHidden="true">
        <FlexboxLayout class="page">
            <StackLayout class="form">
                ...
                <Label class="header" text="ClassHome"></Label>
                ...
                <Label *v-show="isLoggingIn" text="Olvidó su contraseña?"
                    class="login-label" @tap="forgotPassword()"></Label>
            </StackLayout>

            <Label class="login-label sign-up-label" @tap="toggleForm">
                <FormattedString>
                    <Span :text="isLoggingIn ? 'Aún no tiene cuenta? ' : 'Back to Login'"></Span>
                    <Span :text="isLoggingIn ? 'Registrarme' : ''" class="bold"></Span>
                </FormattedString>
            </Label>
        </FlexboxLayout>
    </Page>
